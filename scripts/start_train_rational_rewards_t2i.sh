...
CONFIG="${CONFIG:-examples/nft/lora/qwen_image_rational_rewards_t2i_local_models.yaml}"
...
if [[ "${SKIP_TRAIN_LOG:-0}" != "1" ]]; then
  TRAIN_LOG="${TRAIN_LOG:-${FLOW_CACHE_ROOT}/logs/train_rational_rewards_t2i_$(date +%Y%m%d_%H%M%S).log}"
